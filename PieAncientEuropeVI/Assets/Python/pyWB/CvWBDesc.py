...
class CvWBDesc:
		...
		def write(self, fileName):
				...
				f = file(self.getDescFileName(fileName), "w")   # noqa open text file
		## Platy Builder ##
				f.write("%s\n" % ("Platy Builder"))
		## Platy Builder ##
				f.write("Version=%d\n" % (self.getVersion(),))
		...
		def applyMap(self):
				...
				CyMap().rebuild(self.mapDesc.iGridW, self.mapDesc.iGridH, self.mapDesc.iTopLatitude, self.mapDesc.iBottomLatitude, self.mapDesc.bWrapX,
												self.mapDesc.bWrapY, WorldSizeTypes(worldSizeType), ClimateTypes(climateType), SeaLevelTypes(seaLevelType), 0, None)
...
## Platy Builder ##
		...
		def read(self, fileName):
				...
				f = file(fileName+ext, "r")   # noqa open text file
