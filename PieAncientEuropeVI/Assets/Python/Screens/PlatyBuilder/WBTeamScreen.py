from CvPythonExtensions import (CyGlobalContext, CyGInterfaceScreen,
                                ...
                                WidgetTypes, FontTypes, TableStyles, YieldTypes,
                                ButtonStyles, CyArtFileMgr, DomainTypes)
import CvUtil
# import ScreenInput
...
class WBTeamScreen:
    ...
    def interfaceScreen(self, iTeamX):
        ...
        screen.setText("TeamExit", "Background", "<font=4>" + CyTranslator().getText("TXT_KEY_PEDIA_SCREEN_EXIT", ()).upper() + "</font>", CvUtil.FONT_RIGHT_JUSTIFY,
    ...
    def placeVotes(self):
        ...
        screen.setLabel("VoteHeader", "Background", "<font=3b>" + CyTranslator().getText("TXT_KEY_WB_GUARANTEED_ELIGIBILITY", ()) + "</font>",
        ...
        for item in lVoteBuildings:
            ...
            screen.setTableText("WBTeamVotes", 0, iRow, "<font=3>" + sColor + item[0] + "</font></color>",
                                gc.getBuildingInfo(item[1]).getButton(), WidgetTypes.WIDGET_HELP_BUILDING, item[1], -1, CvUtil.FONT_LEFT_JUSTIFY)
    ...
    def placeRoutes(self):
        ...
        screen.setLabel("RouteHeader", "Background", "<font=3b>" + CyTranslator().getText("TXT_KEY_WB_MODIFY", (sText,)) + "</font>",
                        CvUtil.FONT_CENTER_JUSTIFY, iX + iWidth/2, iY, -0.1, FontTypes.TITLE_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
        iY += 30
    ...
    def placeDomains(self):
        ...
        screen.setLabel("DomainHeader", "Background", "<font=3b>" + CyTranslator().getText("TXT_KEY_WB_MODIFY", (sText,)) + "</font>",
                        CvUtil.FONT_CENTER_JUSTIFY, iX + iWidth/2, iY, -0.1, FontTypes.TITLE_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
        iY += 30
    ...
    def placeImprovements(self):
        ...
        screen.setLabel("ImprovementHeader", "Background", "<font=3b>" + CyTranslator().getText("TXT_KEY_WB_MODIFY", (sText,)) +
                        "</font>", CvUtil.FONT_LEFT_JUSTIFY, iX, iY, -0.1, FontTypes.TITLE_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
    ...
    def placeMembers(self):
        ...
        iX = screen.getXResolution()/4
        screen.setLabel("MemberHeader", "Background", "<font=3b>" + CyTranslator().getText("TXT_KEY_MEMBERS_TITLE", ()) + "</font>",
                        CvUtil.FONT_CENTER_JUSTIFY, iX + iWidth/2, self.iTable_Y - 30, -0.1, FontTypes.TITLE_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
    ...
    def placeAbilities(self):
        ...
        if pTeam.isMapCentering():
            sColor = CyTranslator().getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + CyTranslator().getText("TXT_KEY_WB_MAP_CENTERING", ()) + "</font></color>",
                            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_MAPCENTER").getPath(), lAbilities[0][0], lAbilities[0][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = CyTranslator().getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isMapTrading():
            sColor = CyTranslator().getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + CyTranslator().getText("TXT_KEY_WB_MAP_TRADING", ()) + "</font></color>",
                            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_MAPTRADING").getPath(), lAbilities[1][0], lAbilities[1][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = CyTranslator().getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isTechTrading():
            sColor = CyTranslator().getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + CyTranslator().getText("TXT_KEY_WB_TECH_TRADING", ()) + "</font></color>",
                            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_TECHTRADING").getPath(), lAbilities[2][0], lAbilities[2][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = CyTranslator().getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isGoldTrading():
            sColor = CyTranslator().getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + CyTranslator().getText("TXT_KEY_WB_GOLD_TRADING", ()) + "</font></color>",
                            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_GOLDTRADING").getPath(), lAbilities[3][0], lAbilities[3][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = CyTranslator().getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isOpenBordersTrading():
            sColor = CyTranslator().getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + CyTranslator().getText("TXT_KEY_MISC_OPEN_BORDERS", ()) + "</font></color>",
                            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_OPENBORDERS").getPath(), lAbilities[4][0], lAbilities[4][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = CyTranslator().getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isDefensivePactTrading():
            sColor = CyTranslator().getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + CyTranslator().getText("TXT_KEY_MISC_DEFENSIVE_PACT", ()) + "</font></color>",
                            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_DEFENSIVEPACT").getPath(), lAbilities[5][0], lAbilities[5][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = CyTranslator().getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isPermanentAllianceTrading():
            sColor = CyTranslator().getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + CyTranslator().getText("TXT_KEY_MISC_PERMANENT_ALLIANCE", ()) + "</font></color>",
                            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_PERMALLIANCE").getPath(), lAbilities[6][0], lAbilities[6][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = CyTranslator().getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isVassalStateTrading():
            sColor = CyTranslator().getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + CyTranslator().getText("TXT_KEY_WB_VASSAL_TRADING", ()) + "</font></color>",
                            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_VASSAL").getPath(), lAbilities[7][0], lAbilities[7][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = CyTranslator().getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isBridgeBuilding():
            sColor = CyTranslator().getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + CyTranslator().getText("TXT_KEY_WB_BRIDGE_BUILDING", ()) + "</font></color>",
                            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_BRIDGEBUILDING").getPath(), lAbilities[8][0], lAbilities[8][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = CyTranslator().getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isIrrigation():
            sColor = CyTranslator().getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + CyTranslator().getText("TXT_KEY_CONCEPT_IRRIGATION", ()) + "</font></color>",
                            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_IRRIGATION").getPath(), lAbilities[9][0], lAbilities[9][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = CyTranslator().getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isIgnoreIrrigation():
            sColor = CyTranslator().getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + CyTranslator().getText("TXT_KEY_WB_IGNORE_IRRIGATION", ()) + "</font></color>",
                            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_NOIRRIGATION").getPath(), lAbilities[10][0], lAbilities[10][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = CyTranslator().getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isWaterWork():
            sColor = CyTranslator().getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + CyTranslator().getText("TXT_KEY_WB_WATER_WORK", ()) + "</font></color>",
                            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_WATERWORK").getPath(), lAbilities[11][0], lAbilities[11][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = CyTranslator().getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isExtraWaterSeeFrom():
            sColor = CyTranslator().getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + CyTranslator().getText("TXT_KEY_WB_EXTRA_WATER_SIGHT", ()) + "</font></color>",
                            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_LOS").getPath(), lAbilities[12][0], lAbilities[12][1], -1, CvUtil.FONT_LEFT_JUSTIFY)
